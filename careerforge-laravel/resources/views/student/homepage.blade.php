...
<div class="navbar">
    ...
    <div class="nav-buttons">
        <a href="{{ route('student.register') }}" class="btn-main">Start Learning</a>
        <a href="{{ route('student.login') }}" class="btn-outline-custom">Login</a>
    </div>
</div>
...
function botReply(userText) {
    ...
    if (t.includes('login') || t.includes('sign in')) {
        return 'You can login from here: /student/login (button on top right).';
    }
    if (t.includes('register') || t.includes('signup') || t.includes('sign up')) {
        return 'To create an account, click “Start Learning” or go to /student/register.';
    }
